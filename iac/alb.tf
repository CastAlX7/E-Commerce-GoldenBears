resource "aws_lb" "ecs_alb" {
  ...
  # checkov:skip=CKV_AWS_150: La proteccion contra borrado solo se activa en produccion para facilitar la creacion/destruccion dinamica de infraestructura en ambientes de desarrollo.
